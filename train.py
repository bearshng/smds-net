...
parser.add_argument("--train_path", type=str, help="Path to the dir containing the training datasets.", default="/Users/bearshng/Documents/workspaces/MATLAB/denoising/TDL/data/")
